...
class SectionEditPopup(ctk.CTkToplevel):
    ...
    def setup_ui(self):
        ...
        self.program_var = ctk.StringVar(value=current_program)
    ...
    def update_section(self):
        ...
        # Validation
        if not program_name or program_name == "No programs available":
        ...
        # Call database manager to update section
        ...
        if success:
            ...
            try:
                ...
                SuccessModal(root, message="Section updated successfully!")
