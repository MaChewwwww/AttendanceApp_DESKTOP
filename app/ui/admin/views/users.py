    ...
    def setup_ui(self):
        ...
        if action == "View":
            ...
            if action == "Edit":
                ...
                ctk.CTkButton(btns_frame, text="Save Changes", fg_color="#1E3A8A", hover_color="#1E3A8A", text_color="#fff", width=600, height=36, corner_radius=8).pack(fill="x")
            elif action == "Delete":
                ctk.CTkLabel(self, text="Delete User", font=ctk.CTkFont(size=18, weight="bold"), text_color="#2563EB").pack(pady=(20, 10))
                ...
                ctk.CTkLabel(self, text=f"Programs: {program}", font=ctk.CTkFont(size=14), text_color="#222").pack(anchor="w", padx=30, pady=(5, 10))
